        ...
        <Card.Container>
            ...
            <Card.Content>
                ...
                <p className="text-sm text-slate-400">
                    ...
                    of Monte Carlo Tree Search with Value and Policy networks to predict best possible moves in the game
                    of animal checkers.
    ...
    return (
        <Card.Container>
            ...
            <Card.Content>
                ...
                <p className="text-sm text-slate-400">
                    Simple portfolio site built with React and Tailwind.
                </p>
            </Card.Content>
